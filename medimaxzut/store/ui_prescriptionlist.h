/********************************************************************************
** Form generated from reading UI file 'prescriptionlist.ui'
**
...
#ifndef UI_PRESCRIPTIONLIST_H
#define UI_PRESCRIPTIONLIST_H
...
public:
    ...
    void setupUi(QWidget *PrescriptionList)
    {
        if (PrescriptionList->objectName().isEmpty())
            PrescriptionList->setObjectName("PrescriptionList");
        PrescriptionList->resize(1471, 901);
        PrescriptionList->setMinimumSize(QSize(1471, 901));
        mainFrame = new QFrame(PrescriptionList);
...
"}"));
        ...
        line_13->setGeometry(QRect(630, 60, 3, 41));
        ...
        label1->setGeometry(QRect(90, 60, 521, 31));
        QFont font;
        ...
        label2->setGeometry(QRect(650, 60, 461, 31));
        label2->setFont(font);
...
"border-radius: 10px;"));
        ...
        retranslateUi(PrescriptionList);

        QMetaObject::connectSlotsByName(PrescriptionList);
    } // setupUi

    void retranslateUi(QWidget *PrescriptionList)
    {
        PrescriptionList->setWindowTitle(QCoreApplication::translate("PrescriptionList", "Form", nullptr));
        label1->setText(QCoreApplication::translate("PrescriptionList", "Pacjent", nullptr));
        label2->setText(QCoreApplication::translate("PrescriptionList", "Lekarz Wystawiajacy", nullptr));
        whatListLabel->setText(QCoreApplication::translate("PrescriptionList", "Recepty", nullptr));
        title->setText(QCoreApplication::translate("PrescriptionList", "Lista Recept", nullptr));
    } // retranslateUi

};

namespace Ui {
    class PrescriptionList: public Ui_PrescriptionList {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PRESCRIPTIONLIST_H
