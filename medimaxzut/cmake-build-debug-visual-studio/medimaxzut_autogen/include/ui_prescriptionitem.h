/********************************************************************************
** Form generated from reading UI file 'prescriptionitem.ui'
**
...
#ifndef UI_PRESCRIPTIONITEM_H
#define UI_PRESCRIPTIONITEM_H
...
public:
    ...
    QLabel *medNumLabel;
    QLabel *medNameLabel;
    QPushButton *prescUpdateButton;

    void setupUi(QWidget *PrescriptionItem)
    {
        if (PrescriptionItem->objectName().isEmpty())
            PrescriptionItem->setObjectName("PrescriptionItem");
        PrescriptionItem->resize(571, 61);
        PrescriptionItem->setMinimumSize(QSize(571, 61));
        frame_50 = new QFrame(PrescriptionItem);
...
"border-radius: 10px;"));
        ...
        prescUpdateButton = new QPushButton(frame_50);
        prescUpdateButton->setObjectName("prescUpdateButton");
        prescUpdateButton->setGeometry(QRect(420, 10, 141, 41));
        prescUpdateButton->setFont(font);
        prescUpdateButton->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 41, 94);\n"
"border-radius: 10px;\n"
"color: white;"));

        retranslateUi(PrescriptionItem);

        QMetaObject::connectSlotsByName(PrescriptionItem);
    } // setupUi

    void retranslateUi(QWidget *PrescriptionItem)
    {
        PrescriptionItem->setWindowTitle(QCoreApplication::translate("PrescriptionItem", "Form", nullptr));
        medNumLabel->setText(QCoreApplication::translate("PrescriptionItem", "1", nullptr));
        medNameLabel->setText(QCoreApplication::translate("PrescriptionItem", "Lek3", nullptr));
        prescUpdateButton->setText(QCoreApplication::translate("PrescriptionItem", "Dodaj", nullptr));
    } // retranslateUi

};

namespace Ui {
    class PrescriptionItem: public Ui_PrescriptionItem {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PRESCRIPTIONITEM_H
