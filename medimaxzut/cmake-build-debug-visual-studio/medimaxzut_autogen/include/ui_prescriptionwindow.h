/********************************************************************************
** Form generated from reading UI file 'prescriptionwindow.ui'
**
...
#ifndef UI_PRESCRIPTIONWINDOW_H
#define UI_PRESCRIPTIONWINDOW_H
...
public:
    ...
    {
        if (PrescWindow->objectName().isEmpty())
            PrescWindow->setObjectName("PrescWindow");
        PrescWindow->resize(1471, 901);
        PrescWindow->setMinimumSize(QSize(1471, 901));
        PrescWindow->setMaximumSize(QSize(1471, 901));
        mainFrame = new QFrame(PrescWindow);
...
"border-radius: 10px;"));
        ...
        QMetaObject::connectSlotsByName(PrescWindow);
    } // setupUi

    void retranslateUi(QWidget *PrescWindow)
    {
        PrescWindow->setWindowTitle(QCoreApplication::translate("PrescWindow", "Form", nullptr));
        label_23->setText(QCoreApplication::translate("PrescWindow", "Zawarto\305\233\304\207 recepty", nullptr));
        label_51->setText(QCoreApplication::translate("PrescWindow", "Nazwa", nullptr));
        label_52->setText(QCoreApplication::translate("PrescWindow", "Ilo\305\233\304\207", nullptr));
        label_24->setText(QCoreApplication::translate("PrescWindow", "Lista lek\303\263w w aptece", nullptr));
        label_53->setText(QCoreApplication::translate("PrescWindow", "Nazwa", nullptr));
        label_54->setText(QCoreApplication::translate("PrescWindow", "Stan", nullptr));
...
namespace Ui {
    class PrescWindow: public Ui_PrescWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PRESCRIPTIONWINDOW_H
