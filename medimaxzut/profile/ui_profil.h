...
public:
    ...
    void setupUi(QWidget *profil)
    {
        ...
        profil->resize(558, 381);
        profil->setMinimumSize(QSize(537, 381));
        frame_52 = new QFrame(profil);
...
"border-radius: 10px;"));
    ...
    {
        profil->setWindowTitle(QCoreApplication::translate("profil", "Form", nullptr));
        NameLabel_3->setText(QCoreApplication::translate("profil", "FirstName LastName", nullptr));
        PeselLabel_2->setText(QCoreApplication::translate("profil", "Pesel", nullptr));
        CTLabel_2->setText(QCoreApplication::translate("profil", "nr tel. ", nullptr));
        pnstLabel_2->setText(QCoreApplication::translate("profil", "Polska", nullptr));
        MiastoLabel_2->setText(QCoreApplication::translate("profil", "Szczecin", nullptr));
