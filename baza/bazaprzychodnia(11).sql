...
--
ALTER TABLE `pacjent`
  MODIFY `PacjentID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `wiadomosci`
  MODIFY `WiadomoscID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `wizyta`
--
ALTER TABLE `wizyta`
  MODIFY `WizytaID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
